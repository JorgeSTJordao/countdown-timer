...
import br.com.jorge.countdowntimer.ui.theme.CountdownTimerTheme

//REF: https://www.youtube.com/watch?v=uNW_6TOJ94Q&t=6s
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val viewModelCountDownTimer = CountDownTimerViewModel()
